...
export const EXTERNAL_AGENTS: AgentCard[] = [
  {
    ...
    description: 'Top-tier smart contract auditor — finds vulnerabilities in Anchor/Rust and Solidity',
    capabilities: ['smart-contract-audit', 'gas-optimization'],
    protocol: 'MCP-Connect',
    price: { amount: 0.05, unit: 'SOL' },
    reputation: 98,
    category: 'audit'
  },
  {
  ...
  },
  {
    ...
    protocol: 'MCP-Connect',
    price: { amount: 0.04, unit: 'SOL' }, // Higher price
