          ...
          {([
            ...
            <button
              ...
              style={{
                ...
                borderColor: tab === t_tab.key ? 'var(--accent-500)' : 'var(--border-subtle)',
                background: tab === t_tab.key ? 'rgba(22,163,74,0.1)' : 'transparent',
                color: tab === t_tab.key ? 'var(--accent-500)' : 'var(--text-muted)',
        ...
        {tab === 'protocol' && traces.length > 0 && (
          <button
            ...
            style={{
              ...
              background: showTechnical ? 'var(--accent-500)' : 'transparent',
        ...
        <div style={{
          ...
          {showTechnical && trace.requestHeaders && (
            <div style={{ marginBottom: 8 }}>
              <div style={{ color: 'var(--accent-500)', fontWeight: 700, marginBottom: 4, display: 'flex', alignItems: 'center', gap: 4 }}>
          ...
          {Object.entries(trace.headers || {}).map(([k, v]) => (
            <div key={k}>
              <span style={{ color: '#16a34a' }}>{k}:</span>{' '}
          ...
          {trace.paymentPayload && (
            <>
              <div style={{ color: '#16a34a', fontWeight: 700, marginTop: 8, marginBottom: 4, display: 'flex', alignItems: 'center', gap: 4 }}>
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
        ...
        <span style={{
          fontSize: '0.55rem', color: 'var(--accent-500)',
